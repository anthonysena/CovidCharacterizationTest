...
#
# This file is part of covidCharacterizationTest
#
...
#' @param cohortDatabaseSchema        Schema name where intermediate data can be stored. You will need
...
#'                                    slashes (/). Do not use a folder on a network drive since this
#'                                    greatly impacts performance.
#' @param databaseId                  A short string for identifying the database (e.g. 'Synpuf').
#' @param databaseName                The full name of the database (e.g. 'Medicare Claims Synthetic
#'                                    Public Use Files (SynPUFs)').
#' @param databaseDescription         A short description (several sentences) of the database.
#' @param createCohorts               Create the cohortTable table with the exposure and outcome
#'                                    cohorts?
...
#' @param minCellCount                The minimum number of subjects contributing to a count before it
#'                                    can be included in packaged results.
#'
#' @export
runCohortDiagnostics <- function(connectionDetails,
  ...
  CohortDiagnostics::runCohortDiagnostics(packageName = "covidCharacterizationTest",
